 ...
 const TRAFIKVERKET_API = {
  ...
  function initMap() {
    ...
    updateMap(map, '01', trafficMarkers);
  }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    // Apply custom styles and get state from URL parameters
    const stateCode = applyCustomStyles();
    
    initMap();
    updateMap(map, stateCode, trafficMarkers);
  });